...
public class GoogleAuthenticator {
    ...
    public static final String SEED = "g8GjEvTbW5oVSV7avLBdwIHqGlUYNzKFI7izOF8GwLDVKs2m0QN7vxRs2im5MDaNCWGmcD2rvcZ1";

    public static final String RANDOM_NUMBER_ALGORITHM = "SHA1PRNG";

    public static final int window_size = 3; // default 3 - max 17 (from google docs)最多可偏移的时间
    ...
    public static void main(String[] args) {
        ...
        String url = GoogleAuthenticator.getQRBarcodeURL("username", "ipay", secret);
        System.out.println("Please register " + url);
        System.out.println("Secret key is " + secret);

//        String savedSecret = "CCUGPFKSCWKFC7RS";
//        long code = 247443;
